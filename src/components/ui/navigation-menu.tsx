...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ...
    // Adicione estas props para desativar o hover
    delayDuration={0} // Remove o delay para abrir
    skipDelayDuration={0} // Remove o delay para fechar
    {...props}
  >
    {children}
...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger
    ...
    // Adicione esta prop para garantir que só abra ao clicar
...
>(({ className, ...props }, ref) => (
  <div className={cn("absolute left-0 top-full flex justify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        " origin-top-center relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-xl border bg-muted text-popover-foreground shadow data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 md:w-[var(--radix-navigation-menu-viewport-width)]",
        className
      )}
      ref={ref}
      {...props}
